...
export default function AdminPasswordResetPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      <Header />
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 pt-24 pb-10 space-y-6">
        {/* 헤더 */}
        ...
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-5 py-4 text-sm text-amber-800 space-y-1">
          <p className="font-semibold">비밀번호 초기화 정책</p>
          <ul className="list-disc list-inside space-y-0.5 text-amber-700">
            <li>초기화된 비밀번호는 즉시 효력이 발생합니다.</li>
            <li>사용자는 다음 로그인 시 비밀번호 변경이 강제됩니다.</li>
            <li>임시 비밀번호는 안전한 방법(전화, 보안 메신저 등)으로 전달하세요.</li>
            <li>화면을 벗어나면 임시 비밀번호를 다시 확인할 수 없습니다.</li>
          </ul>
        </div>
      </main>
    </div>
